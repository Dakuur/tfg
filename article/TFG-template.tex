...
\fancyhead[RE]{\scriptsize EE/UAB TFG DADES: TÍTOL (ABREUJAT SI
ÉS MOLT LLARG)}
...
\blfootnote{$\bullet$ Treball tutoritzat per: nom i cognoms del
tutor (departament)} \blfootnote{$\bullet$ Curs 20xx/xx}
